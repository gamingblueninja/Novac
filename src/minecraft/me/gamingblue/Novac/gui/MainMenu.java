...
import me.gamingblue.Novac.alt.GuiAltManager;
...
public class MainMenu extends GuiScreen{
	...
	public void drawScreen(int mouseX, int mouseY, float partialticks) {
		...
		for(String name : buttons) {
			...
			this.drawCenteredString(mc.fontRendererObj, name, (width / buttons.length) * count + (width /buttons.length /2f + 8), y, hovered ? 0xbaa0da : -10000000);
			count++;
		...
		GlStateManager.translate(-(width / 2f), -(height /2f), 0);
		this.drawCenteredString(fontRendererObj, Novac.name, width /2f, height /2.5f - mc.fontRendererObj.FONT_HEIGHT /2f, -10000000);
		GlStateManager.pushMatrix();
