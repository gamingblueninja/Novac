...
public class Gui
{
     ...
     */
    public static void drawRect(double e, double offset, double g, double d, int color)
    {
        if (e < g)
        {
            int i = (int) e;
        ...
        worldrenderer.pos((double)e, (double)d, 0.0D).endVertex();
        worldrenderer.pos((double)g, (double)d, 0.0D).endVertex();
        worldrenderer.pos((double)g, (double)offset, 0.0D).endVertex();
        worldrenderer.pos((double)e, (double)offset, 0.0D).endVertex();
        tessellator.draw();
